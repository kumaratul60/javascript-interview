// Array Unique Values and Related Examples
...
// From uniqVal_JsInteresting.js (unique part)
const my_array2 = [1, 2, 2, 3, 3, 4, 5, 5];
const unique_array2 = [...new Set(my_array2)];
console.log(unique_array2); //[1,2,3,4,5]

// Additional examples from uniqVal_JsInteresting.js
// array.sort()
...
//////////////////////////
// When you want that timer function? console.time() & console.timeEnd()
console.time("timer1");
console.time("timer2");
setTimeout(() => {
